...
This is a SwiftUI framework. It uses [MusicKit](https://developer.apple.com/documentation/MusicKit/) to learn what music media in Music.app do not have artwork. On macOS there is also an option to use the [iTunesLibrary framework](https://developer.apple.com/documentation/ituneslibrary). It then uses MusicKit to search for the artwork on Apple's Catalog.
